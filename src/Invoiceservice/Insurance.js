      ...
      <View style={styles.section}>
        ...
        <View style={styles.insuranceContainer}>
          <View style={styles.policyDetails}>
            ...
            <Text style={styles.infoHeader1}>Address: {invoice.bill_to.address_1}</Text>
            <Text style={styles.infoHeader1}>Policy No: {invoice.invoice_no}</Text>
            ...
            <Text style={styles.infoHeader1}>Policy Start Date: {payment_date}</Text>
            <Text style={styles.infoHeader1}>Policy End Date: {due_date}</Text>
          </View>
